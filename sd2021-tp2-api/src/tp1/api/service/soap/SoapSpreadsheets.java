...
public interface SoapSpreadsheets {
	...
	void deleteUserSpreadsheet(String userId, String secret) throws SheetsException;
	...
	String[][] getImportValues(String sheetId, String userId, String secret) throws SheetsException;
}
