...
public class DeleteFile {
	...
	private static final String CREATE_FOLDER_V2_URL = "https://api.dropboxapi.com/2/files/delete_v2";
	...
	public boolean execute( String directoryName ) {
		...
		createFolder.setPayload(json.toJson(new DeleteFileArgs(directoryName)));
